...
export const LoginByMobile = (payload) => (dispatch) => {
  axios
    .post("https://bigbasketclon.herokuapp.com/BigBasket/login", payload, {
      withCredentials: true,
    })
    .then((res) => {
...
export const NewUserRegistration = (payload) => (dispatch) => {
  axios
    .post("https://bigbasketclon.herokuapp.com/BigBasket/signup", payload, {
      withCredentials: true,
    })
    .then((res) => {
...
export const OtpVerification = (payload, alert, navigate) => (dispatch) => {
  axios
    .post("http://localhost:8080/BigBasket/login/otp", payload, {
      withCredentials: true,
    })
    .then((res) => {
